...
public class ShipmentDemoRunner {
    public void run() {
    ...
    private Shipment buildSampleShipment() {
        Customer customer = new Customer("Nova Trading", 8, true, false, 5000);
    ...
    private ShipmentService buildShipmentService() {
        return new ShipmentService(new PricingService(), new PermissionService(),
